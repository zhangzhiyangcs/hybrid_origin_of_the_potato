...
rule LTR:
    ...
    shell:
        ...
        {EDTA}
        {sing}
        cd {params.DIR} && export LC_ALL=C && singularity exec /work/home/zhangzhiyang/software/EDTA.sif EDTA_raw.pl --genome {wildcards.name}.fa --species {species} --type ltr --threads {threads}
        """
...
rule TIR:
    ...
    shell:
        ...
        {EDTA}
        {sing}
        cd {params.DIR} && export LC_ALL=C && singularity exec /work/home/zhangzhiyang/software/EDTA.sif  EDTA_raw.pl  --genome {wildcards.name}.fa --species {species} --type tir --threads {threads} --overwrite 1
        """
...
rule Helitron:
    ...
    shell:
        ...
        {EDTA}
        {sing}
        cd {params.DIR} && export LC_ALL=C && singularity exec /work/home/zhangzhiyang/software/EDTA.sif EDTA_raw.pl  --genome {wildcards.name}.fa --species {species} --type helitron --threads {threads}  --overwrite 1
        """
...
rule final:
    ...
    threads: 12
    run:
        cmd =  "export LC_ALL=C && cd " + params.DIR + "&& singularity exec /work/home/zhangzhiyang/software/EDTA.sif EDTA.pl --genome " + wildcards.name + ".fa  --species " + species
        cmd = cmd + " cd " + params.DIR + "  && singularity exec /work/home/zhangzhiyang/software/EDTA.sif EDTA.pl --genome " + wildcards.name + ".fa  --species " + species
        if lib :
